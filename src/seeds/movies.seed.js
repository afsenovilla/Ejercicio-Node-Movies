...
mongoose.connect("mongodb+srv://root:root@cluster0.4vaqxuf.mongodb.net/albertoDB?retryWrites=true&w=majority")
.then(async () => {
...
.catch((error) => console.log("Error eliminando películas", error))
.then(async () => {
